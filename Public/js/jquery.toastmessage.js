...
var Toast = {
    'success': function () {
        return doDeal(arguments,'success');
    },
    'notice': function (message) {
        return doDeal(arguments,'notice');
    },
    'warn': function (message) {
        return doDeal(arguments,'warn');
    },
    'error': function (message) {
        return doDeal(arguments,'error');
    },
    /**
     *
     * @param message
     ...
     * @returns {jQuery}
     */
    'show': function (message,sticky,position,type,closeText,close) {
        return $().toastmessage('showToast', {
            text: message,
            sticky: sticky, position: position, type: type, closeText: closeText,
            close: close
        });
    }
};
