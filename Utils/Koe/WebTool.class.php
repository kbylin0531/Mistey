...
class WebTool{
     ...
     * @return array|bool
     */
    public static function url_header($url){
        $name = '';$length=0;
        ...
        if(!$name){
            $name = FileTool::get_path_this($url);
     ...
     * @return int
     */
    public static function select_var($array){
     ...
     * @param string $msg
     */
    public static function go_url($url, $msg = ''){
     ...
     * @param int $isgo
     */
    public static function show_msg($message, $url = '#', $time = 3, $isgo = 1)
    {
...
endline;
     ...
     */
    public static function send_http_status($i_status, $s_message = ''){
        $a_status = array(
            // Informational 1xx
            100 => 'Continue',
    ...
    public static function get_os (){
        ...
        if(null === $os){
            throw new \Exception('Oprate system message get failed!');
        }
        return $os;
    }
