        ...
        <div id="think_page_trace_tab_cont" style="overflow:auto;height:212px;padding: 0; line-height: 24px">
            ...
            <?php
                if(is_array($info)){
                    ...
                    echo '<li style="border-bottom:1px solid #EEE;font-size:14px;padding:0 12px"><span style="color: blue">' . (is_numeric($k) ? '' : $k.' : </span>') .
